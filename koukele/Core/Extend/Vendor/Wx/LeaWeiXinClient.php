...
class LeaWeiXinClient {
    function submit($url, $data, $cookie = false) {
        return $this->exec($url, $data, $cookie, true, false);
    }

    function get($url, $cookie) {
        return $this->exec($url, false, $cookie, false, false);
    }

    function upload($url,$data,$cookie = false){
        return $this->exec($url,$data,$cookie,true,true);
    }
     ...
     */
    private function exec($url, $data, $cookie = false, $isPost = true,$isUpload = false) {
        $dataStr = "";
