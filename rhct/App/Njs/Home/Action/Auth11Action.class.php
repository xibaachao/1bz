...

{
...

    {
        ...
        $auth_url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid={$config['AppId']}&redirect_uri={$redirect}&response_type=code&scope=snsapi_base&state=1#wechat_redirect&openid={$_GET['openid']}";
