		...
		<table class="table table-striped table-hover" id="sample_1">
			...
			<tbody>
				<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="odd gradeX">
					...
					<td style='width: 40px;'><?php if(($vo["is_show"]) == "0"): ?><span style="color:red">已隐藏</span><?php endif; ?></td>
					<td><?php echo ($vo["name"]); ?></td>
					<td><?php echo ($vo["people"]); ?></td>
					<td><?php echo ($vo["phone"]); ?></td>
					<td><?php echo ($vo["time"]); ?></td>
					<td><?php echo ($vo["vote"]); ?></td>
					<td><?php if(($vo["is_show"]) == "1"): ?><a href=""></a> <a
							href='<?php echo U(MODULE_NAME."/show_no",array("id"=>$vo["id"]));?>'
							class='btn default btn-xs'> <i class='icon-edit'></i> 隐藏
						</a> <?php else: ?> <a href=""></a> <a
							href='<?php echo U(MODULE_NAME."/show_ok",array("id"=>$vo["id"]));?>'
							class='btn default btn-xs'> <i class='icon-edit'></i> 显示
						</a><?php endif; ?> <a href=""></a> <a
						href='<?php echo U(MODULE_NAME."/edit",array("id"=>$vo["id"]));?>'
						class='btn default btn-xs'> <i class='icon-edit'></i> 查看详细
					</a>
